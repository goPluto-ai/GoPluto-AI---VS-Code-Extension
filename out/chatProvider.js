...
exports.PlutoAIChatProvider = void 0;
class PlutoAIChatProvider {
    ...
    async sendMessage(message) {
        if (!this.apiKey || this.apiKey.trim().length < 10) {
            throw new Error("GoPluto AI API key not configured or invalid. " +
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (response.status === 401) {
                    ...
                    throw new Error("GoPluto AI service is temporarily unavailable. Please try again later.");
                }
                else {
    ...
    async testApiKey() {
        ...
        try {
            const response = await fetch("https://api.gopluto.ai/api/users/llm-response", {
                method: "POST",
                headers: {
                    Authorization: `Bearer ${this.apiKey}`,
                    "Content-Type": "application/json",
...
exports.PlutoAIChatProvider = PlutoAIChatProvider;
